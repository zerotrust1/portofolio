...
export default function Home() {
  const projects = [
    {
      title: "Calmflow",
      description: "CalmFlow is a meditation app that helps users to relax and meditate. Built with Next.js and Tailwind CSS.",
    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-black font-sans">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group block p-6 md:p-8 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-900/50"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {certifications.map((cert, i) => (
              <div
                key={i}
                className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 bg-white/50 dark:bg-black/40"
              >
      ...
      <footer className="w-full px-6 md:px-8 py-6 border-t border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-black/50">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Email: fahrel02x@gmail.com
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            WhatsApp:+62 858-6128-4237
          </p>
        </div>
